  ...
  return (
    <>
      ...
      <div className="announcement-banner">
        ...
        <p><strong>Instant delivery within 30-45mins.</strong> Shop only at <a href="https://nammasihiisweets.netlify.app" className="highlight-text">nammasihiisweets.netlify.app</a></p>
      </div>
